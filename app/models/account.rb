...
class Account < ApplicationRecord
  ...
  validates :username, presence: true, format: { with: /\A[e0-9_]+\z/i, message: 'only e, numbers and underscores' }, uniqueness: { scope: :domain, case_sensitive: false }, length: { maximum: 30 }, if: 'local?'
